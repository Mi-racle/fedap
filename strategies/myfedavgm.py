...
from flwr.common import (
    ...
    parameters_to_ndarrays, log, EvaluateRes,
)
...
class MyFedAvgM(FedAvgM):
    ...
    def aggregate_evaluate(
        ...
        np.savetxt(f'runs/confusion_matrix_avgm.csv', confusion_matrix, delimiter=',')
        ...
        with open(f'runs/loss_fedavgm.txt', 'a+') as fout:
            fout.write(str(loss_aggregated) + '\n')
        with open(f'runs/accuracy_fedavgm.txt', 'a+') as fout:
