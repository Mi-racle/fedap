...
from flwr.common import (
    ...
    parameters_to_ndarrays, EvaluateRes, log,
)
...
class MyFedAdam(FedAdam):
    ...
    def aggregate_evaluate(
        ...
        np.savetxt(f'runs/confusion_matrix_adam.csv', confusion_matrix, delimiter=',')
        ...
        with open(f'runs/loss_fedadam.txt', 'a+') as fout:
            fout.write(str(loss_aggregated) + '\n')
        with open(f'runs/accuracy_fedadam.txt', 'a+') as fout:
